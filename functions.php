...
function wp_theme_register_script() {
	 ...
	 */
	wp_enqueue_style('champee-style', get_stylesheet_uri(), array(), '1.0.0');
	
	/**
	 * Register js script file(js/client.js) 
	 * dependency on jQuery, and place this before close body tag
	 */
	wp_register_script('champee-client', get_theme_file_uri('/js/clients.js'), array('jquery'), '1.0.0', true);
